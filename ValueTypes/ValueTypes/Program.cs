...
namespace ValueTypes
{
    class TypeExercise
    {
        ...
        {
            decimal faktor = steuerProdukt ?? steuerKategorie ?? (decimal) 1.2;

            return nettopreis * faktor;
        }
        ...
        public int BerechneAchtel(long wert)
        {
            ...
            // Wenn ein Wert vom Typ long eingegeben wird, der größer als jeder Wert vom Typ int ist,
            // dann wird keine Exception ausgegeben.
            // 
            // Bsp:
            // long wert = 9223372036854775807;
            // return (int) wert;
            // --> Gibt den Wert -1 zurück. Die Werte bleiben in der Größe, die integer annehmen können.
        }
    }
    class Program
    {
